...
class TvDetailPage extends StatefulWidget {
  static const String ROUTE_NAME = '/tv/detail';
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ElevatedButton(
                              onPressed: () async {
                                if (!isAddedWatchlist) {
                                  await Provider.of<TvDetailNotifier>(context, listen: false).addWatchListTv(tv);
                                } else {
                                  await Provider.of<TvDetailNotifier>(context, listen: false).removeFromWatchlistTv(tv);
                                }
                            ...
                            Text(
                              _showDuration(tv.episodeRunTime.length),
                            ),
                            Row(
                              children: [
                                RatingBarIndicator(
                            ...
                            Consumer<TvDetailNotifier>(
                              builder: (context, data, child) {
                                if (data.tvRecommendationsState == RequestState.Loading) {
                                  return Center(
                                    child: CircularProgressIndicator(),
                                  );
                                } else if (data.tvRecommendationsState == RequestState.Error) {
                                  return Text(data.message);
                                } else if (data.tvRecommendationsState == RequestState.Loaded) {
                                  return Container(
                                    height: 150,
